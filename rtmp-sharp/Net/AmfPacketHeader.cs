...
namespace RtmpSharp.Net
{
	...
	public class AmfPacketHeader
	{
		...
		public AmfPacketHeader(string name, bool mustUnderstand, object content)
		{
			this.name = name;
		...
		public bool IsClearedCredentials
		{
			get
			{
				if( content is string )
					return (string)content == AmfPacketHeader.ClearedCredentials;
				return false;
			}
		}
	}
